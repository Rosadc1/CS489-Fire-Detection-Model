...
#----------------------------------- Dataset Configs -----------------------------------#
config_args.add_argument('--dataset_dir', type = str, default = "../../../data/objectDetection/Dataset", help = "The root directory of the dataset")
config_args.add_argument('--image_dir', type = str, default = "images", help = "The root directory of the image files")
config_args.add_argument('--annotation_dir', type = str, default = "labels", help = "root directory of object detection annotations")
config_args.add_argument('--weights', type = str, default = "yolov8n.pt", help = "root directory of object detection annotations")
