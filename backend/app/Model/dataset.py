...
class ClassifierDataset(Dataset): 
    """ Attributes: args: Configuration ArgumentParser. img_transform: Transformation pipeline for input images. classification_map: Mapping of class names to integer labels. image_paths: List of file paths to the images. labels: List of integer labels corresponding to each image. """
    def __init__(self, args) -> None:
        ...
        self.classification_map = { "Non_fire": 0, "Fire": 1 } 
        self.image_paths = [] 
        self.labels = [] 
